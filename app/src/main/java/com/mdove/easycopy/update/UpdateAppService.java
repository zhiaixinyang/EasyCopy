...
public class UpdateAppService extends Service {
    ...
    class DownloadCompleteReceiver extends BroadcastReceiver {
        ...
        private void installAPK(Context context, String path) {
            ...
            if (file.exists()) {
                ...
                Toast.makeText(context, StringUtil.getString(R.string.string_download_err), Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void openFile(File var0, Context var1) {
        ...
        try {
            ...
            Toast.makeText(var1, StringUtil.getString(R.string.string_open_apk_err), Toast.LENGTH_SHORT).show();
        }
    }
