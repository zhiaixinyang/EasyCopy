...
public class CircleWaveView extends View {
    ...
    public CircleWaveView setMaxRadiusRate(float maxRadiusRate) {
        mMaxRadiusRate = maxRadiusRate;
        return this;
    }

    public CircleWaveView setColor(int color) {
        mPaint.setColor(color);
        return this;
    }

    public CircleWaveView setStyle(Paint.Style style) {
        mPaint.setStyle(style);
        return this;
    }

    public CircleWaveView setInitialRadius(float radius) {
        mInitialRadius = radius;
        return this;
    }

    public CircleWaveView setInitialAlpha(int alpha) {
        mInitialAlpha = alpha;
        return this;
    }

    public CircleWaveView setDuration(long duration) {
        mDuration = duration;
        return this;
    }

    public CircleWaveView setMaxRadius(float maxRadius) {
        mMaxRadius = maxRadius;
        mMaxRadiusSet = true;
        return this;
    }

    public CircleWaveView setSpeed(int speed) {
        mSpeed = speed;
        return this;
    }

    public CircleWaveView setInterpolator(Interpolator interpolator) {
